...
task("deploy:addSender", "Adding sender to client contract")
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        console.log("Adding contract sender...");
        let tx = await targetContract.addSender(taskArgs.senderAddress, gasPrice > 0 ? {gasPrice: gasPrice} : {});
