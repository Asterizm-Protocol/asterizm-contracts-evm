...
async function deployBase(hre, implementationVersion, isTestnet) {
    ...
    const Token = await ethers.getContractFactory("OmniChainTokenUpgradeableV" + implementationVersion);
...
task("token-base:upgrade", "Update base OmniChain token contracts")
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        console.log("Upgrading base OmniChain token implementation...");
        ...
        console.log("Base OmniChain token implementation upgrade successfully");
