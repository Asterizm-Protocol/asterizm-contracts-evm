...
async function deployBase(hre, implementationVersion, isTestnet) {
    ...
    const Token = await ethers.getContractFactory("OmniChainStakeTokenUpgradeableV" + implementationVersion);
...
task("token-stake-token:upgrade", "Update stake token OmniChain token contracts")
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        console.log("Upgrading stake token OmniChain token implementation...");
