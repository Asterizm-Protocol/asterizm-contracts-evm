...
contract LendingPoolUpgradeableV1 is UUPSUpgradeable, ILendingPool, AsterizmWithdrawalUpgradeable {
    ...
    function initialize(address _manipulator, IERC20 _liquidToken) initializer public {
