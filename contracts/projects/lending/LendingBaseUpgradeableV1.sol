...
contract LendingBaseUpgradeableV1 is ILendingBase, AsterizmClientUpgradeable {
    ...
    function initialize(IInitializerSender _initializerLib, address _liquidityFeeCollector) initializer public {
